...
RUN CGO_ENABLED=0 go build \
  -o ./dist/gotunnel \
  && upx-ucl --best --ultra-brute ./dist/gotunnel
...
COPY --from=builder /build/dist/gotunnel /bin/
WORKDIR /workdir
ENTRYPOINT ["/bin/gotunnel"]
